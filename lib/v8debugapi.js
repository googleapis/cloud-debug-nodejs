...
/** @const */ var sm = require('source-map');
  ...
  singleton = {
    ...
    set: function(breakpoint, cb) {
      ...
      if (!fileStats.compilationInfo[fullPath]) {
        ...
        try {
          var consumer = new sm.SourceMapConsumer(compInfo.sourceMap);
