...
Logger.prototype.error = function() {
  this.log_(Logger.ERROR, Array.prototype.slice.call(arguments));
};
Logger.prototype.warn = function() {
  this.log_(Logger.WARN, Array.prototype.slice.call(arguments));
};
Logger.prototype.info = function() {
  this.log_(Logger.INFO, Array.prototype.slice.call(arguments));
};
Logger.prototype.debug = function() {
  this.log_(Logger.DEBUG, Array.prototype.slice.call(arguments));
};
